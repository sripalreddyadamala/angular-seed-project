...
```
git clone https://github.com/sripalreddyadamala/angular-seed-project
cd angular-seed
```
...
```
git clone --depth=1 https://github.com/sripalreddyadamala/angular-seed-project<your-project-name>
```
